...
import com.reecegroup.controllers.RestResponseEntityExceptionHandler;
import com.reecegroup.services.CustomerService;
import com.reecegroup.services.ResourceNotFoundException;
...
public class CustomerControllerTest extends AbstractRestControllerTest {
    ...
    public void testListCustomers() throws Exception {
        ...
        customer1.setPhonenumber("11111");
        ...
        customer4.setPhonenumber("33333");
        customer4.setBookid(2L);
        customer4.setCustomerUrl(CustomerController.BASE_URL + "/4");
    ...
    @Test
    public void testListCustomersByBookid() throws Exception {
        ...
        customer3.setLastname("Watson");
        customer3.setPhonenumber("33333");
        customer3.setBookid(2L);
        customer3.setCustomerUrl(CustomerController.BASE_URL + "/3");

        when(customerService.getCustomersByBookId(1L)).thenReturn(Arrays.asList(customer1, customer2));

        mockMvc.perform(get(CustomerController.BASE_URL + "/book/1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void testGetCustomerById() throws Exception {
        ...
        customer1.setFirstname("Michale");
        customer1.setLastname("Weston");
        customer1.setPhonenumber("33333");
        customer1.setBookid(1L);
        customer1.setCustomerUrl(CustomerController.BASE_URL + "/1");
    ...
    public void createNewCustomer() throws Exception {
        ...
        customer.setPhonenumber("33333");
        customer.setBookid(1L);
