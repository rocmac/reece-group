...
import com.reecegroup.api.v1.mapper.CustomerMapper;
import com.reecegroup.api.v1.model.CustomerDTO;
import com.reecegroup.controllers.v1.CustomerController;
...
public class CustomerServiceImpl implements CustomerService {
    ...
    @Override
    public List<CustomerDTO> getCustomersByBookId(Long bookid) {
        return customerRepository
                .findByBookid(bookid)
                .stream()
                .map(customer -> {
